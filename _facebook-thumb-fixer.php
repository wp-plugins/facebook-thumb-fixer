...
class general_setting_default_fb_thumb {
    ...
    function fields_html() {
		...
		echo '<p class="description">This is the full path to your default Facebook thumb (Ideally 155 x 155px. Go <a href="' . admin_url( '/options-general.php?page=facebook-thumb-fixer' ) . '">here</a> for more information.)</p>';
		if ($fbt_value) {
