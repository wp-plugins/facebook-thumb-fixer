...
<div class="wrap" style="margin:0 340px 0 0 !important;">
  ...
  <h3 id="topic03" style="border-top:solid 1px #ccc; margin:20px 0; padding:20px 0 0 0;">What if you don't use Featured Images on your pages or posts?</h3>
    ...
    <p>To test if you have a conflict, simply view the source code of your home page and search for any instances of <strong>og:</strong> within. Typically a plugin will output the meta tags into it's own group. For this plugin, they will be directly below the comment <strong>&lt;!--/ Facebook Thumb Fixer Open Graph /--&gt;</strong> but other plugins will output differently.</p>
