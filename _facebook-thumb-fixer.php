...
function admin_load_fbf_css(){
	wp_enqueue_style( 'styles', plugins_url( '/css/ftf.css', __FILE__ ), false, '1.0.0', 'all');
	add_thickbox();
}
...
<div class="task-rocket">
    ...
    <p><a href="http://taskrocket.info/?type=landing" target="_blank">Take it for a test flight</a></p>
</div>
